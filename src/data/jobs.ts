...
export const PHYSICAL_JOBS: Job[] = [
  {
    ...
    npcName: 'Marco',
    npcDialogue: '¿Buscas trabajo? Necesito un barista para el turno. El pago es $300 y te tomará un turno.',
  },
  {
    id: 'cashier',
    name: 'Cajero',
    ...
    npcName: 'Daniela',
    npcDialogue: 'Hola, ¿vienes por el trabajo de cajero? Paga $350 por turno.',
  },
  {
    id: 'waiter',
    name: 'Mesero',
    ...
    npcName: 'Carlos',
    npcDialogue: 'Necesito un mesero para el turno de hoy. $400 y propinas.',
  },
  {
    id: 'delivery',
    name: 'Repartidor',
    ...
    npcName: 'Luis',
    npcDialogue: 'Tengo varias entregas hoy. Te pago $500 si las haces todas.',
  },
  {
    id: 'bar_dj',
    name: 'DJ en Bar',
    ...
    icon: '/icons/dj.svg',
    npcName: 'Sofía',
    npcDialogue: 'Oye, ¿sabes poner música? Necesito un DJ para esta noche. $600.',
  },
  {
    id: 'music_teacher',
    ...
    npcDialogue: 'Busco un instructor de música para clases particulares. $800 por sesión.',
  },
];
...
export const JOB_DIALOGUES: JobDialogue[] = [
  {
    jobId: 'barista',
    greet: '¿Buscas trabajo? Necesito un barista para el turno. El pago es $300 y te tomará un turno.',
  ...
  {
    jobId: 'cashier',
    greet: 'Hola, ¿vienes por el trabajo de cajero? Paga $350 por turno.',
  ...
  {
    jobId: 'waiter',
    greet: 'Necesito un mesero para el turno de hoy. $400 y propinas.',
  ...
  {
    jobId: 'delivery',
    greet: 'Tengo varias entregas hoy. Te pago $500 si las haces todas.',
  ...
  {
    jobId: 'bar_dj',
    greet: 'Oye, ¿sabes poner música? Necesito un DJ para esta noche. $600.',
  ...
  {
    jobId: 'music_teacher',
    greet: 'Busco un instructor de música para clases particulares. $800 por sesión.',
