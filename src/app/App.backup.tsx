  ...
  return (
    <div className="w-screen h-screen overflow-hidden bg-purple-950">
      ...
      {(currentScreen === 'loading' || isLoading) && (
        <LoadingScreen progress={100} message={loadingMessage} />
      )}

      {/* Pantalla del menú principal */}
      {currentScreen === 'main_menu' && !isLoading && <SimpleMenu />}
      
      {/* Pantalla del juego */}
      {currentScreen === 'game' && <GameScene />}

      {/* Pantallas lazy loaded con Suspense */}
      <Suspense fallback={<LoadingScreen progress={50} message="Cargando..." />}>
